...
function updateElementPosition(element, scaleWidth, orientationWidth, scaleHeight, orientationHeight, type) {
  ...
  // let laptopElement = document.getElementById("gif_laptop");
  // updateElementPosition(laptopElement, 0.25, "right", 0.6, "top", "laptop");

  // let catElement = document.getElementById("gif_cat");
  // updateElementPosition(catElement, 0.4, "left", 0.45, "top", "cat");

  // let girlElement = document.getElementById("gif_girl");
  // updateElementPosition(girlElement, 0.4, "left", 0.45, "bottom", "girl");

  // let cupHolderElement = document.getElementById("gif_cup_holder");
  // updateElementPosition(cupHolderElement, 0.37, "right", 0.64, "top", "cup_holder");